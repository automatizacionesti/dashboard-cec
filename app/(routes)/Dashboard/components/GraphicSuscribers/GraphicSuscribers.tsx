  ...
  return (
    <div className="mt-5">
        ...
        <div className="flex gap-x-5 mb-5">
            ...
            <p className="text-slate-500">+432 aumento</p>
        </div>
        <div className="h-[350px]">
            <ResponsiveContainer width="100%" height="100%">
                ...
                <YAxis />
                <Tooltip />
                <Area type="monotone" dataKey="newCustomers" stroke="#887CFD" fill="url(#colorUv)" />
                <Area type="monotone" dataKey="oldCustomers" stroke="#82ca9d" fill="url(#colorPv)" />
                </AreaChart>
            </ResponsiveContainer>
        </div>
    </div>
